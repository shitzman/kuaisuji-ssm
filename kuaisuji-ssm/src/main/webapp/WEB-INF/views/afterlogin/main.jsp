<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import = "com.kuaisuji.po.Account,java.util.List,com.kuaisuji.po.Type,java.util.Map,com.kuaisuji.po.User"%>
...
<div class="fly-panel fly-column">
  <div class="layui-container">
    <ul class="layui-clear">
      <li class="layui-hide-xs layui-this"><a href="index">主页</a></li> 
      <%
      Map<Integer,Type> typeMap = (Map<Integer,Type>)request.getSession().getAttribute("typeMap");
      for(Integer key : typeMap.keySet()){
    	  
      %>
      	 <li><a href="getaccountsbyitem?cid=<%=key%>"><%=typeMap.get(key).getAccount_item_name() %></a></li> 
      <%
      }
      %>
    ...
    <div class="fly-column-right layui-hide-xs"> 
      ...
      <a href="add0" class="layui-btn">记一笔</a> 
    </div> 
    ...
    <div class="layui-col-md12">
      <div class="fly-panel" style="margin-bottom: 0;">
        ...
        <div class="fly-panel-title fly-filter">
          <a href="getaccounts?type=0">支出</a>
          <span class="fly-mid"></span>
          <a href="getaccounts?type=1">收入</a>
          <span class="fly-mid"></span>
          <a href="getaccounts?type=2">全部</a>
        ...
        <ul class="fly-list">  
         	...
         	<%
         	List<Account> allAccountList = (List<Account>)request.getAttribute("accountList");
